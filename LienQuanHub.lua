...
spawn(function() 
    ...
    wait(.5)
    require(game.ReplicatedStorage.Notification).new("<Color=Yellow>Liên Quân Hub Make By Bố Sơn<Color=/>"):Display()
    wait(.24)
    require(game.ReplicatedStorage.Notification).new("<Color=Yellow>Hãy Sử Dụng Để Có Trải Nghiệm Tốt!!<Color=/>"):Display()
    wait(.29)
    require(game.ReplicatedStorage.Notification).new("<Color=Yellow>Đăng Ký Kênh Dino Để Xem Video Mới Nhất Nhé<Color=/>"):Display()
    wait(.36)
end)

local OrionLib = loadstring(game:HttpGet(('https://raw.githubusercontent.com/shlexware/Orion/main/source')))()
local Window = OrionLib:MakeWindow({Name = "Liên Quân Hub", HidePremium = false, IntroText = "Liên Quân Hub", SaveConfig = true, ConfigFolder = "NightHub"})
...
W:AddLabel("Make By Bố Sơn")
W:AddLabel("Liên Quân Hub Vip")
W:AddLabel("Discord tên cần đổi")
local Section = W:AddSection({
    Name = "Status"
})
